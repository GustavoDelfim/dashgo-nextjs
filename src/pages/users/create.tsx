...
export default function CreateUser () {
  ...
  const handleCreateUser = handleSubmit<CreateUserFormData>(async (values) => {
          ...
          <Box as="form" onSubmit={handleCreateUser}>
            <VStack spacing={["6", "8"]}>
              ...
              <SimpleGrid minChildWidth="240px" spacing={["6", "8"]} w="100%">
                ...
                <Input name="password_conconfirmation" type="password" label="Confirmação da senha" {...register('password_confirmation')} error={errors.password_confirmation} />
              </SimpleGrid>
            </VStack>
